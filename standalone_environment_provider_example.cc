...
int main()
{
    ...
    G4cout
        << "[EnvironmentProviderExample] Running 10 ordinary "
    ...
    G4cout
        << "[EnvironmentProviderExample] PASS: run completed "
        << "through FixedPsSourceEnvironmentProvider without "
        << "PsSource generator, truth, event action, or tracking action."
        << G4endl;
